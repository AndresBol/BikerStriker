...
This project was developed as the final assignment for the Programming II course, demonstrating skills in object-oriented programming, relational database design, layered architecture, design patterns, and GUI development.
