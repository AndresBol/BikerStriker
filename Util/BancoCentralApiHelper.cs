...
{
    public class BancoCentralApiHelper
    {
        private readonly string TOKEN = "BDM02PSLBP";
        private readonly string NOMBRE = "Andrés Bolaños";
        private readonly string CORREO = "andresbol1706@gmail.com";


        public double ObtenerTipoCambio(DateTime fecha)
        {
            try
            {
